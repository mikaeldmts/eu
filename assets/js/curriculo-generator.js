    ...
    repos: [
        {
            id: 1,
            name: 'portfolio',
            full_name: 'mikaeldmts/portfolio',
        ...
        },
        {
            ...
            full_name: 'mikaeldmts/curriculo-generator',
            description: 'Gerador de currículo dinâmico com Firebase',
            html_url: 'https://github.com/mikaeldmts/curriculo-generator',
            language: 'JavaScript',
            stargazers_count: 2,
            forks_count: 1,
...
window.syncGitHubPhotoManually = async function() {
    const username = prompt('Digite o username do GitHub:', curriculumData.personalInfo.github || 'mikaeldmts');
    if (!username) return;
...
window.loadGitHubProjects = async function() {
    try {
        ...
        repos.forEach(repo => {
            if (!repo.fork && repo.name.toLowerCase() !== 'mikaeldmts') {
                const project = {
                    id: `github-${repo.id}`,
                    nome: repo.name,
    ...
    return `
        ...
        ">
            ...
            <div style="
                ...
                opacity: 0.7;
            ">
                <span>Portfólio: mikaeldmts.github.io/eu • Atualizado em ${today}</span>
            </div>
            ...
            <!-- Footer do Portfolio -->            <footer style="
                ...
                font-size: 0.8rem;
            ">
                <p style="margin: 0;">Currículo gerado via Portfolio Profissional • Mikael Ferreira • mikaeldmts.github.io/eu</p>
                ...
                <p style="margin-top: 0.5rem; font-size: 0.65rem; color: #94a3b8;">
                    Portfolio desenvolvido com HTML5, CSS3, JavaScript, Firebase, RESTful APIs e GitHub Actions • GitHub: github.com/mikaeldmts
                </p>
            </footer>
        </div>
    `;
    ...
    return `
        <header style="margin-bottom: 2rem; text-align: center; border-bottom: 2px solid ${curriculumData.settings.primaryColor}; padding-bottom: 1rem;">
            ...
            <div style="font-size: 0.65rem; color: #999; text-align: center; margin-top: 0.5rem;">
                <span>Mais informações e projetos completos disponíveis em: mikaeldmts.github.io/eu</span>
            </div>
        </header>
    `;
}
    ...
    return `
        <section style="margin-bottom: 2rem;">            <h3 class="section-title" style="color: ${curriculumData.settings.primaryColor}; border-bottom: 1px solid #ccc; padding-bottom: 0.5rem;">
            ...
            <div style="font-size: 0.65rem; color: #999; text-align: right; margin-top: 0.5rem;">
                <span>Histórico completo e referências disponíveis em: mikaeldmts.github.io/eu/mentors.html</span>
            </div>
        </section>
    `;
}
...
function generateProjectsSection() {
    ...
    return `
        <section style="margin-bottom: 2rem;">            <h3 class="section-title" style="color: ${curriculumData.settings.primaryColor}; border-bottom: 1px solid #ccc; padding-bottom: 0.5rem;">
            ...
            `).join('')}
            <div style="font-size: 0.65rem; color: #999; text-align: right; margin-top: 0.5rem;">
                <span>Todos os projetos com código-fonte e demonstrações em: mikaeldmts.github.io/eu/projetos.html</span>
            </div>
        </section>
    `;
}
    ...
    return `
        <section style="margin-bottom: 2rem;">            <h3 class="section-title" style="color: ${curriculumData.settings.primaryColor}; border-bottom: 1px solid #ccc; padding-bottom: 0.5rem;">
            ...
            <div style="font-size: 0.65rem; color: #999; text-align: right; margin-top: 0.3rem;">
                <span>Para mais detalhes: mikaeldmts.github.io/eu/projetos.html</span>
            </div>
        </section>
    `;
}
...
function generateCertificatesSection() {
    ...
    return `
        <section style="margin-bottom: 2rem;">            <h3 class="section-title" style="color: ${curriculumData.settings.primaryColor}; border-bottom: 1px solid #ccc; padding-bottom: 0.5rem;">
            ...
            `).join('')}
            <div style="font-size: 0.65rem; color: #999; text-align: right; margin-top: 0.5rem;">
                <span>Certificados em andamento e comprovantes disponíveis em: mikaeldmts.github.io/eu/pages/certificates-in-progress.html</span>
            </div>
        </section>
    `;
}
